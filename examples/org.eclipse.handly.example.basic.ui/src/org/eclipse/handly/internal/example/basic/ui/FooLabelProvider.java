...
import org.eclipse.handly.example.basic.core.IFooDef;
...
import org.eclipse.handly.example.basic.core.IFooVar;
    ...
    extends LabelProvider
{
    ...
    {
        if (element instanceof IFooDef)
            return FooUiPlugin.getImage(FooUiPlugin.IMG_OBJ_DEF);
        if (element instanceof IFooVar)
            return FooUiPlugin.getImage(FooUiPlugin.IMG_OBJ_VAR);
